...
const AdminSideBar = () => {
    ...
    const SideBarLinks = [
        ...
        {
            title: "Veification Aprovals",
            icon: "https://i.ibb.co.com/tMmhnS60/image.png",
            path: "/admindashboard/adminverificationaprovals"
        },
        {
            title: "Message",
        ...
        <div className='col-span-2 pt-12'>
            ...
            <div className='pl-12 space-y-5 my-5'>
                {SideBarLinks.map((item, index) => (
                    <AdminSideBardLinks key={index} object={item} />
                ))}
