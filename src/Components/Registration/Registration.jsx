                ...
                <div className="space-y-4 mx-[148px]">
                    ...
                    <div className="relative ">
                        ...
                        <span className="absolute bottom-3 right-6" onClick={() => setShowPassword(!showPassword)}>
                            {
                                showPassword ? <FaEyeSlash className="h-[20px] w-[22px]" ></FaEyeSlash> : <FaRegEye  className="h-[20px] w-[22px]"></FaRegEye>
                            }
                        </span>
                    </div>
                    ...
                    <button className="btn roboto text-[14px] font-normal bg-[#1976D2] text-white w-full py-3 rounded-lg mt-4">
                        Create an account
                    </button>
