        ...
        <div className='grid grid-cols-5 gap-[32px]'>
            ...
            <div className='flex flex-col '>
                ...
                <div className='flex flex-col gap-4 items-center justify-center w-full text-gray-400'>
                    {/* Select Skills */}
                    <select className="select select-bordered w-[252px] ">
                    ...
                    {/* Job Title */}
                    <input type="text" placeholder="Type here" className="input input-bordered w-[252px]" />
                    ...
                    {/* Salary Currency */}
                    <div className='flex w-[252px] justify-between gap-2'>
                        {/* Salary */}
                ...
                <div className='flex flex-col items-center gap-5'>
                    <hr className='w-[252px]' />
                    <button className='flex justify-center items-center gap-2 p-2 rounded bg-[#0079C1] w-[252px]'>
                    ...
                    <button className='flex justify-center items-center gap-2 p-2 rounded bg-[#E5F5FF] w-[252px]'>
